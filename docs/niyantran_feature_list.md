# Niyantran — Complete Feature List
...
- Two seed accounts: `controller@niyantran.in` / `fleet@niyantran.in`
...
### Overview
A trained model (XGBoost or RandomForest) that predicts incident duration and severity using 8000+ real Bengaluru traffic incidents provided in the dataset. This is what separates Niyantran from teams that just wrap an LLM.
...
```
┌─────────────────────────────────────────────────────────────────┐
│  NIYANTRAN          [Active Events: 2]  [Fleet: 8/12 deployed]   │
├──────────────────────────────┬──────────────────────────────────┤
│                              │  ACTIVE EVENTS                   │
│                              │  ┌──────────────────────────┐   │
│                              │  │ 🔴 IPL Match             │   │
